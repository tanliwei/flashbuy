...
public class CodeMsg {
    ...
    public static final CodeMsg REQUEST_ILLEAGAL = new CodeMsg(500102, "Illegal request");
    public static CodeMsg ACCESS_LIMIT_REACHED= new CodeMsg(500103, "Access too many!");
    ...
    public static final CodeMsg FLASHBUY_FAIL = new CodeMsg(500503, "The Flash Buy fails");
